...
!function (global, setTimeout) {
  ...
  function newContext(e) {
    function t(e, t, i) {
      ...
      if (e && (u = (e = e.split("/")).length - 1, E.nodeIdCompat && jsSuffixRegExp.test(e[u]) && (e[u] = e[u].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && l && (e = l.slice(0, l.length - 1).concat(e)), function (e) {
        var t, i;
        ...
        e:for (o = (n = e.split("/")).length; o > 0; o -= 1) {
          if (s = n.slice(0, o).join("/"), l) for (a = l.length; a > 0; a -= 1) if ((r = getOwn(h, l.slice(0, a).join("/"))) && (r = getOwn(r, s))) {
            c = r, d = o;
            break e
          }
    ...
    function r(e) {
      ...
      if (t && isArray(t) && t.length > 1) return t.shift(), x.require.undef(e), x.makeRequire(null, {skipMap: !0})([e]), !0
    }
    ...
    function o(e, i, r, o) {
      ...
      return e || (l = !1, e = "_@r" + (P += 1)), d = (c = n(e))[0], e = c[1], d && (d = t(d, p, o), s = getOwn(M, d)), e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
        return t(e, p, o)
      }) : -1 === e.indexOf("!") ? t(e, p, o) : e : (d = (c = n(h = t(e, p, o)))[0], h = c[1], r = !0, a = x.nameToUrl(h))), {
        prefix: d,
        name: h,
        parentMap: i,
    ...
    function a(e) {
      var t = e.id, i = getOwn(w, t);
      return i || (i = w[t] = new x.Module(e)), i
    }

    function s(e, t, i) {
      var r = e.id, n = getOwn(w, r);
    ...
    function c() {
      globalDefQueue.length && (each(globalDefQueue, function (e) {
        var t = e[0];
        "string" == typeof t && (x.defQueueMap[t] = !0), k.push(e)
      }), globalDefQueue = [])
    }

    function d(e) {
      delete w[e], delete y[e]
    }

    function p() {
      var e, t, n = 1e3 * E.waitSeconds, o = n && x.startTime + n < (new Date).getTime(), a = [], s = [], c = !1,
        d = !0;
      if (!g) {
        if (g = !0, eachProp(y, function (e) {
          var n = e.map, u = n.id;
          if (e.enabled && (n.isDefine || s.push(e), !e.error)) if (!e.inited && o) r(u) ? (t = !0, c = !0) : (a.push(u), i(u)); else if (!e.inited && e.fetched && n.isDefine && (c = !0, !n.prefix)) return d = !1
        }), o && a.length) return (e = makeError("timeout", "Load timeout for modules: " + a, null, a)).contextName = x.contextName, u(e);
        d && each(s, function (e) {
          !function e(t, i, r) {
            var n = t.map.id;
            t.error ? t.emit("error", t.error) : (i[n] = !0, each(t.depMaps, function (n, o) {
              var a = n.id, s = getOwn(w, a);
              !s || t.depMatched[o] || r[a] || (getOwn(i, a) ? (t.defineDep(o, M[a]), t.check()) : e(s, i, r))
            }), r[n] = !0)
          }(e, {}, {})
    ...
    function h(e) {
      ...
      return l(t, x.onScriptLoad, "load", "onreadystatechange"), l(t, x.onScriptError, "error"), {
        node: t,
    ...
    function m() {
      var e;
      for (c(); k.length;) {
        if (null === (e = k.shift())[0]) return u(makeError("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1]));
        f(e)
      }
      x.defQueueMap = {}
    }

    var g, v, x, b, q, E = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}},
    ...
    return b = {
      ...
      this.events = getOwn(S, e.id) || {}, this.map = e, this.shim = getOwn(E.shim, e.id), this.depExports = [], this.depMaps = [], this.depMatched = [], this.pluginMaps = {}, this.depCount = 0
    }).prototype = {
      init: function (e, t, i, r) {
        ...
        var e = this.map.url;
        O[e] || (O[e] = !0, x.load(this.map.id, e))
      }, check: function () {
              ...
              if (this.defining = !0, this.depCount < 1 && !this.defined) {
                if (isFunction(o)) {
                  if (this.events.error && this.map.isDefine || req.onError !== defaultOnError) try {
                    ...
                    e = t
                  } else n = x.execCb(i, o, r, n);
                  if (this.map.isDefine && void 0 === n && ((t = this.module) ? n = t.exports : this.usingExports && (n = this.exports)), e) return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "define" : "require", u(this.error = e)
                } else n = o;
        ...
        this.depMaps.push(r), s(r, "defined", bind(this, function (r) {
          var n, c, p, f = getOwn(j, this.map.id), l = this.map.name,
          ...
          return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function (e) {
            return t(e, h, !0)
          }) || ""), s(c = o(e.prefix + "!" + l, this.map.parentMap), "defined", bind(this, function (e) {
            this.map.normalizedMap = c, this.init([], function () {
              return e
            }, null, {enabled: !0, ignore: !0})
          })), void ((p = getOwn(w, c.id)) && (this.depMaps.push(c), this.events.error && p.on("error", bind(this, function (e) {
            this.emit("error", e)
          })), p.enable()))) : f ? (this.map.url = x.nameToUrl(f), void this.load()) : ((n = bind(this, function (e) {
            this.init([], function () {
              return e
            }, null, {enabled: !0})
          })).error = bind(this, function (e) {
            this.inited = !0, this.error = e, e.requireModules = [i], eachProp(w, function (e) {
              0 === e.map.id.indexOf(i + "_unnormalized") && d(e.map.id)
            }), u(e)
          }), n.fromText = bind(this, function (t, r) {
            var s = e.name, c = o(s), d = useInteractive;
            r && (t = r), d && (useInteractive = !1), a(c), hasProp(E.config, i) && (E.config[s] = E.config[i]);
            try {
              req.exec(t)
            } catch (e) {
              return u(makeError("fromtexteval", "fromText eval for " + i + " failed: " + e, e, [i]))
            }
            d && (useInteractive = !0), this.depMaps.push(c), x.completeLoad(s), m([s], n)
          }), void r.load(e.name, m, n, E))
        })), x.enable(r, this), this.pluginMaps[r.id] = r
      }, enable: function () {
        y[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function (e, t) {
          var i, r, n;
          if ("string" == typeof e) {
            if (e = o(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap), this.depMaps[t] = e, n = getOwn(b, e.id)) return void (this.depExports[t] = n(this));
          ...
          i = e.id, r = w[i], hasProp(b, i) || !r || r.enabled || x.enable(e, this)
      ...
      configure: function (e) {
        ...
        var i = E.shim, r = {paths: !0, bundles: !0, config: !0, map: !0};
        eachProp(e, function (e, t) {
          ...
          var t;
          t = (e = "string" == typeof e ? {name: e} : e).name, e.location && (E.paths[t] = e.location), E.pkgs[t] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "")
      ...
      makeRequire: function (r, n) {
        ...
        return n = n || {}, mixin(s, {
          isBrowser: isBrowser, toUrl: function (e) {
            ...
            return -1 !== n && (!("." === o || ".." === o) || n > 1) && (i = e.substring(n, e.length), e = e.substring(0, n)), x.nameToUrl(t(e, r && r.id, !0), i, !0)
          }, defined: function (e) {
            return hasProp(M, o(e, r, !1, !0).id)
          }, specified: function (e) {
            return e = o(e, r, !1, !0).id, hasProp(M, e) || hasProp(w, e)
          }
        }), r || (s.undef = function (e) {
          c();
          var t = o(e, r, !0), n = getOwn(w, e);
          n.undefed = !0, i(e), delete M[e], delete O[t.url], delete S[e], eachReverse(k, function (t, i) {
            t[0] === e && k.splice(i, 1)
          }), delete x.defQueueMap[e], n && (n.events.defined && (S[e] = n.events), d(e))
        }), s
      },
      enable: function (e) {
      ...
      completeLoad: function (e) {
        ...
        if (x.defQueueMap = {}, n = getOwn(w, e), !t && !hasProp(M, e) && n && !n.inited) {
          if (!(!E.enforceDefine || a && getGlobal(a))) return r(e) ? void 0 : u(makeError("nodefine", "No define call for " + e, null, [e]));
      ...
      nameToUrl: function (e, t, i) {
        ...
        if (c && (e = c), u = getOwn(j, e)) return x.nameToUrl(u, t, i);
        if (req.jsExtRegExp.test(e)) a = e + (t || ""); else {
          for (r = E.paths, o = (n = e.split("/")).length; o > 0; o -= 1) if (s = getOwn(r, n.slice(0, o).join("/"))) {
  ...
  var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath,
    ...
    defContextName = "_", isOpera = "undefined" != typeof opera && "[object Opera]" === opera.toString(), contexts = {},
    cfg = {}, globalDefQueue = [], useInteractive = !1;
  if (void 0 === define) {
    if (void 0 !== requirejs) {
